...
class Popular extends React.Component {
  render() {
    return (
      ...
      <div className="flex flex-wrap items-center justify-center dark:bg-gray-800 ">
      <h3 class="font-bebas-neue lowercase text-5xl sm:text-6xl font-black flex flex-col leading-none dark:text-white text-gray-800 dark:bg-gray-800 text-center mr-10">
                Popular Items
        ...
        <div className="flex-shrink-0 mx-2 mb-6 relative overflow-hidden bg-yellow-500 rounded-lg max-w-xs shadow-lg">
          ...
          <div className="relative text-white px-6 pb-6 mt-6">
            ...
            <div className="flex justify-between">
              <span className="block font-semibold text-xl">Outfit</span>
        ...
        <div className="flex-shrink-0 mx-2 mb-6 sm:mb-0 relative overflow-hidden bg-blue-500 rounded-lg max-w-xs shadow-lg">
          ...
          <div className="relative pt-10 px-10 flex items-center justify-center">
            <div className="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3"></div>
            <img className="relative w-40" src={HeroImage} alt="shopping" />
          </div>
          <div className="relative text-white px-6 pb-6 mt-6">
